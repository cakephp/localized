...
class RuValidation extends LocalizedValidation
{
    ...
    {
        $pattern = '/^((1[0-2][1-9]|110|120)|14[0-24]|15[0236]|16[01236789]|17[03]|18[03-8]|19\d|214|236|24[18]|30[01258]|344|35[0589]|36[0-4789]|39[0246-8]|40[034]|41[04]|42[04568]|43[0-2]|44[03]|45[0234]|460|555|60[012367]|61[049]|62[0589]|63[04]|64[04789]|65[056]|66[04579]|67[0125789]|68[035789]|69[03])\d{3}$/';
     ...
     */
    public static function vatin(string $check): bool
    {
        $pattern = '/^\d{10}|\d{12}$/';
        ...
        $digits = str_split(strval($check)); // getting digits & positions from id string
     ...
     */
    public static function snils(string $check): bool
    {
        ...
        $calculatedChecksum = str_pad(strval($calculatedChecksum), 2, '0', STR_PAD_LEFT);
